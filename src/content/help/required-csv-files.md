...
StayRecap builds each report from three core CSV exports: a reservations file, an expenses file, and an optional financial transactions file from your accounting system. Together, these give the engine a complete picture of revenue, costs, and net operating performance for each property.
